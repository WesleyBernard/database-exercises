...
INSERT INTO `albums` (`artist`, `album_name`, `release_date`, `sales`, `genres`)
VALUES ('Alanis Morissette', 'Jagged Little Pill', '1995', '24.3', 'Alternative rock');

INSERT INTO `albums` (`artist`, `album_name`, `release_date`, `sales`, `genres`)
VALUES ('Michael Jackson', 'Dangerous', '1991', '17.0', 'New jack swing, R&B and pop');

INSERT INTO `albums` (`artist`, `album_name`, `release_date`, `sales`, `genres`)
VALUES ('Celine Dion', 'Falling into You', '1996', '21.1', 'Pop, soft rock');

INSERT INTO `albums` (`artist`, `album_name`, `release_date`, `sales`, `genres`)
VALUES ('The Beatles', 'Sgt. Pepper''s Lonely Hearts Club Band', '1967', '18.21', 'Rock');

INSERT INTO `albums` (`artist`, `album_name`, `release_date`, `sales`, `genres`)
VALUES ('Patrick Swayze', 'Dirty Dancing', '1987', '17.9', 'Pop, rock, R&B');

INSERT INTO `albums` (`artist`, `album_name`, `release_date`, `sales`, `genres`)
VALUES ('Adele', '21', '2011', '26.4', 'Pop, soul');
...
INSERT INTO `albums` (`artist`, `album_name`, `release_date`, `sales`, `genres`)
VALUES ('Madonna', 'The Immaculate Collection', '1990', '19.5', 'Pop, dance');
...
VALUES ('Michael Jackson', 'Thriller', '1982', '49.2', 'Pop, post-disco, funk, rock'),
       ...
       ('Fleetwood Mac', 'Rumours', '1977', '29.7', 'Soft rock'),
